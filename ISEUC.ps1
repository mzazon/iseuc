...
# Date: 11-9-2012
# Author: Mike Zazon
# Notes: Adapted from Rich Prescott's ANUC PS tool
#========================================================================
#----------------------------------------------
...
<OPTIONS Product="ISE Lab User Creation Tool" Version="1.2">
 <Settings>
...
function Call-ISEUC_pff {
	...
	$formMain.Text = "ISE Lab User Creation Tool"
	...
	$CSVTemplate.FileName = "ISEUCusers.csv"
	$CSVTemplate.Filter = "CSV Files|*.csv|All Files|*.*"
	$CSVTemplate.ShowHelp = $True
	$CSVTemplate.Title = "Create CSV Template For ISEUC"
	$CSVTemplate.add_FileOk($CSVTemplate_FileOk)
	#
	# OFDImportCSV
	#
	$OFDImportCSV.FileName = "C:\ISEUC\ISEUCUsers.csv"
